    ...
    <>
      <div className="page-head">
        <div className="container">
          <h1>Membership</h1>
          <p>Join the CAIRO community to save your learning progress, earn certificates and register for events.</p>
        </div>
      </div>
                ...
                return (
                  <div key={c.id} className="card" style={{ marginBottom: 12 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <Link to={`/lms/${c.id}`} className="btn btn-ghost btn-sm">{pct > 0 ? 'Continue' : 'Start'}</Link>
                    </div>
