...
export default function Course() {
  ...
  if (!course) return <div className="section container"><div className="empty">Course not found. <Link to="/lms">Back to LMS</Link></div></div>
    ...
    <>
      <div className="page-head">
        <div className="container">
          <Link to="/lms" style={{ color: '#fff', opacity: 0.85, fontSize: '0.9rem' }}>← All courses</Link>
  ...
  return (
    <div style={{ marginBottom: 28 }}>
      <div className="certificate">
        <div style={{ fontSize: '0.8rem', letterSpacing: 3, color: 'var(--muted)', textTransform: 'uppercase' }}>CAIRO Journal Club</div>
