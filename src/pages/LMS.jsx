    ...
    <>
      <div className="page-head">
        <div className="container">
          <span className="badge badge-gold">Core of the portal</span>
          <h1 style={{ marginTop: 10 }}>Learning Management System</h1>
        ...
        <div className="container">
          ...
          <div className="grid grid-2">
            {courses.map((c) => {
              ...
              return (
                <Link key={c.id} to={`/lms/${c.id}`} className="card card-link" style={{ padding: 0, overflow: 'hidden' }}>
