...
const BANNERS = [
  ['Purple → Blue', 'linear-gradient(135deg,#6d2077,#1b9cd8)'],
  ['Teal → Green', 'linear-gradient(135deg,#00a896,#7cb518)'],
  ['Red → Gold', 'linear-gradient(135deg,#e63946,#f4a300)'],
  ['Blue deep', 'linear-gradient(135deg,#1b9cd8,#0f6fa0)'],
  ['Purple deep', 'linear-gradient(135deg,#6d2077,#4d1554)']
]
